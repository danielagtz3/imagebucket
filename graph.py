...
def create_graph(data):
    ...
    start_index, new_color = lines[num_vertices + 2 + num_edges].split(",")
    return graph, int(start_index), new_color
...
def main():
    ...
    graph, start_index, new_color = create_graph(data)
    ...
    # run bfs
    graph.bfs(start_index, new_color)
    # reset by creating graph again
    graph = create_graph(data)[0]  
    # run dfs
    graph.dfs(start_index, new_color)
